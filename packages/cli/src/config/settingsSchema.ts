  ...
  tools: {
    ...
    properties: {
      ...
      fileOperations: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Limits for File Operations',
        showInDialog: true,
        properties: {
          maxFileSizeBytes: {
            type: 'number',
            ...
            category: 'Tools',
            requiresRestart: false,
            default: 20971520, // TODO: right now is 500 change to 100 mb
            description:
              'Maximum file size in bytes that can be read. Files exceeding this will be rejected.',
            showInDialog: true,
          },
          maxLinesPerFile: {
            type: 'number',
